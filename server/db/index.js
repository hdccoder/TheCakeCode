...
const seed = async()=> {
  const babyBabyCake_image = await loadImage('dl.dropboxusercontent.com/s/3rlqt6vhid1dvg1bpqu7x/baby-baby-cake.jpg?rlkey=jvholqempkqutn9o3dmhm5iqk&dl=0');
  const beatlesCake_image = await loadImage('https://dl.dropboxusercontent.com/s/ylrieaxixmbehzme32kyp/beatles-cake.jpg?rlkey=4342v9xlbz3hq8hrtrf1g22bh&dl=0');
  const candyAisleCake_image = await loadImage('https://dl.dropboxusercontent.com/s/8e4arsxkvxyf34ftigaxr/candy-aisle-cake.jpg?rlkey=vdp9b76hqv1ho3gnjf47vg5zb&dl=0');
  const chocolateStripesCake_image = await loadImage('https://dl.dropboxusercontent.com/s/940oj51diwblclb6lt77f/chocolate-stripes-cake.jpg?rlkey=tmuiq0t68ln171kec7xdc5kim&dl=0');
  const christmasTrainCakes_image = await loadImage('https://dl.dropboxusercontent.com/s/35ez2ut4om96qk8l2ustw/christmas-train-cakes.jpg?rlkey=og0v1yga5hvqqrcqmqyupykaz&dl=0');
  const coconutCupcake_image = await loadImage('https://dl.dropboxusercontent.com/s/jcjfbqqhtcue3r7wuk1ez/cupcake-letters.jpg?rlkey=h3203qt54y2nur287qv1k1w3s&dl=0');
  const cupcakeLetters_image = await loadImage('https://dl.dropboxusercontent.com/s/8dkhajdealrzeez4i1m31/earl-grey-cupcakes.jpg?rlkey=za7s57gd77u93l3yny1h64kiy&dl=0');
  const earlGreyCupcakes_image = await loadImage('https://dl.dropboxusercontent.com/s/8dkhajdealrzeez4i1m31/earl-grey-cupcakes.jpg?rlkey=za7s57gd77u93l3yny1h64kiy&dl=0');
  const elmoCupcakes_image = await loadImage('https://dl.dropboxusercontent.com/s/34iz1e6ygnoeppdb8k75t/elmo-cupcakes.jpg?rlkey=q1v01fdyscc479az3293d3k5q&dl=0');
  const fairyCake_image = await loadImage('https://dl.dropboxusercontent.com/s/e5q1nmadaw4y87mw3bfxv/fairy-cake.jpg?rlkey=alhqj8m1llzy4u44ts3ljo6d9&dl=0');
  const flashCake_image = await loadImage('https://dl.dropboxusercontent.com/s/padr1dnl484bezin44lhl/flash-cake.jpg?rlkey=y86ulkxv9upundcr42hxkyjp8&dl=0');
  const flowerCake_image = await loadImage('https://dl.dropboxusercontent.com/s/fhfvljlj2wgxwf6ecb9gy/flower-cake.jpg?rlkey=scn8ntu15c3oq0zk8wrtur7ux&dl=0');
  const flowerpotCupcakes_image = await loadImage('https://dl.dropboxusercontent.com/s/z0q5v8xrj4r6fm59y8ccw/gold-black-cake.jpg?rlkey=vn1jl0yl0bc7758ktkcxgrsib&dl=0');
  const goldBlackCake_image = await loadImage('https://dl.dropboxusercontent.com/s/yiqomtfrkvphqs65il64z/halloween-cupcakes.jpg?rlkey=yepbzamf91xf6znj4hidmdynr&dl=0');
  const halloweenCupcakes_image = await loadImage('https://dl.dropboxusercontent.com/s/di4cl3p5u6jnv8kb7ir8l/hello-kitty-cupcake.jpg?rlkey=jiajxc142bt5h2f3e9ub0crku&dl=0');
  const helloKitty_image = await loadImage('https://dl.dropboxusercontent.com/s/6tn5al33iyj4tq4pncglo/keylime-cupcake.jpg?rlkey=d6mlg4bid7paq4f79w23wq0eb&dl=0');
  const keylimeCupcakes_image = await loadImage('https://dl.dropboxusercontent.com/s/6tn5al33iyj4tq4pncglo/keylime-cupcake.jpg?rlkey=d6mlg4bid7paq4f79w23wq0eb&dl=0');
  const maybeImCrazyCake_image = await loadImage('https://dl.dropboxusercontent.com/s/3i0fvz6covkntdiusln2c/maybe-im-crazy-cake.jpg?rlkey=1xdivvg2ebbe4b6oj6cdbgt48&dl=0');
  const mistletoeCake_image = await loadImage('https://dl.dropboxusercontent.com/s/ib6n59ijw337yny25vpe5/mistletoe-cake.jpg?rlkey=05mav15m65rm9e6079gne43fm&dl=0');
  const mountainCake_image = await loadImage('https://dl.dropboxusercontent.com/s/0s8nvg0e4i24ch493eerz/mountain-cake.jpg?rlkey=ev4zwagb37i77g93rjzjv862p&dl=0');
  const oreoCake_image = await loadImage('https://dl.dropboxusercontent.com/s/svx7ybs8zikepumlty9pn/oreo-cake.jpg?rlkey=pw7nluwdvh679vfiuzld9ahw0&dl=0');
  const pooEmoji_image = await loadImage('https://dl.dropboxusercontent.com/s/mocujjmjx7wlyjxmt2rhi/poo-emoji-cupcakes.jpg?rlkey=k8w9pqc8nxncs6tk83sg7eu0s&dl=0');
  const prettyInPinkCupcake_image = await loadImage('https://dl.dropboxusercontent.com/s/f5ivrwuwx0mgo4x5zgeqn/pretty-in-pink-cupcake.jpg?rlkey=r59k043ufjr5iq2dovtzuvrou&dl=0');
  const princessCake_image = await loadImage('https://dl.dropboxusercontent.com/s/b8yguzf2q6w1o9p2a1jlr/princess-cake.jpg?rlkey=efw55gy8r8biyru2kvnoawnrt&dl=0');
  const rainbowCake_image = await loadImage('https://dl.dropboxusercontent.com/s/3wv5nsvpo96vmjznp88vp/rainbow-cake.jpg?rlkey=ppb8va15bq4wwysvslkxjazh4&dl=0');
  const skittlesCake_image = await loadImage('https://dl.dropboxusercontent.com/s/c0ypli8t0v8kl4ejsp6qm/skittles-cake.jpg?rlkey=s9qe9ofao2rhde3d0aa5qug92&dl=0');
  const smallWeddingCake_image = await loadImage('https://dl.dropboxusercontent.com/s/c0ypli8t0v8kl4ejsp6qm/skittles-cake.jpg?rlkey=s9qe9ofao2rhde3d0aa5qug92&dl=0');
  const snowHouseCake_image = await loadImage('https://dl.dropboxusercontent.com/s/5ysq0xrs4xklvq7jkp03d/snow-house-cake.jpg?rlkey=y02hapeuf7kvtliu7750dok3c&dl=0');
  const soccerDirtCake_image = await loadImage('https://dl.dropboxusercontent.com/s/j9p5x80vlhqg7j8r55ck8/soccer-dirt-cake.jpg?rlkey=oz5kb9hxf01udak619ruvc6vr&dl=0');
  const thanksgivingCake_image = await loadImage('https://dl.dropboxusercontent.com/s/qwg9fctbeeqs3vcw0tqlj/thanksgiving-cake.jpg?rlkey=2aa9moxjl26bevynieql6slu8&dl=0');
  const unicornCake_image = await loadImage('https://dl.dropboxusercontent.com/s/qia7uhvq7sgrl2rzvztxa/unicorn-cake.jpg?rlkey=yix4nenft0uwfbmyoenslbtt2&dl=0');
  const valentinesDayCake_image = await loadImage('https://dl.dropboxusercontent.com/s/zn5epg9nil6gtbzc054n1/valentines-day-cake.jpg?rlkey=xf09v9p1e0xup1nkmrfqi39ds&dl=0');
  const weddingCake_image = await loadImage('https://dl.dropboxusercontent.com/s/kh5cs961bkfdqq5qd2o5u/wedding-cake.jpg?rlkey=csp11i6yqzrf7vfnt6ewhvg6u&dl=0');
  const koalaCake_image = await loadImage('https://dl.dropboxusercontent.com/s/t4ta9qg1u3fmwrad93kyi/koala-cake.jpg?rlkey=02lhyzyunhk6h7tc0bl1rbxbs&dl=0');
  ...
  const [foo, bar, bazz,quq] = await Promise.all([
    ...
    createProduct({ name: 'Lily Cake', price: 200.00, description:"This small three-layer cake makes a great casual wedding cake or is perfect for Mother's Day. It features a vanilla cake with whip cream frosting. The flowers on top are handpiped and edible.", vip_price: 0, category:'Special Occasions', productImage: 'smallWeddingCake_image' }),
    ...
    createProduct({ name: 'Peaches & Cream Wedding Cake', price: 500.00, description:'This two tiered wedding cake is composed of buttermilk cake, peach buttercream, and filled with peach compote.  The outside is covered in a silky French vanilla buttercream.  Delicate handmade flowers wrap around the outside of the cake.', vip_price: 0, category:'Special Occasions', productImage: 'weddingCake_image' }),
